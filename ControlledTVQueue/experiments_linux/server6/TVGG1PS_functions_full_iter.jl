...
function do_experiment(queue::String, control::String, target::Float64, arrival::String, service::String, coeff::Tuple, T::Float64, N::Int64, record::Record)
    ...
    file_num_in_queue = open("../logs2/$(queue)/$(target)/$(arrival),$(service)/$(queue)_$(target)_$(control)_$(arrival)_$(service)_$(coeff[3])_$(T)_$(N)_queue_length.txt" , "w")
    file_virtual_sojourn_time = open("../logs2/$(queue)/$(target)/$(arrival),$(service)/$(queue)_$(target)_$(control)_$(arrival)_$(service)_$(coeff[3])_$(T)_$(N)_sojourn_time.txt" , "w")
    running_mark = open("../logs2/$(queue)/$(target)/$(arrival),$(service)/running_$(queue)_$(target)_$(control)_$(arrival)_$(service)_$(coeff[3])_$(T)_$(N).txt", "w")
    ...
    rm("../logs2/$(queue)/$(target)/$(arrival),$(service)/running_$(queue)_$(target)_$(control)_$(arrival)_$(service)_$(coeff[3])_$(T)_$(N).txt")
    completion_mark = open("../logs2/$(queue)/$(target)/$(arrival),$(service)/completed_$(queue)_$(target)_$(control)_$(arrival)_$(service)_$(coeff[3])_$(T)_$(N).txt", "w")
