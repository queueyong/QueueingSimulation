...
service_table = readdlm("$THIS_FILE_PATH/../../../table/service/SR/10.0/ER,ER/table_fcn2_service_SR_ER_ER.txt")
T = 22000.0
N = 400
record = Record()
LOG_PATH = "$THIS_FILE_PATH/../log" 

do_experiment_table_slave(queue, control, target, arrival, service, fcn, fcn_type, arrival_table, service_table, T, N, record, LOG_PATH, 24)
